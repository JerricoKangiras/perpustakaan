...
// QUERY DINAMIS
// ======================
$where = "WHERE LOWER(s.judul_buku) LIKE '%jujutsu kaisen%'";
...
$start = ($page - 1) * $limit;
$jjk_books = array_slice($jjk_books, $start, $limit);
?>
...
<head>
    ...
    <title>Detail Buku Jujutsu Kaisen</title>
...
.input-box button:hover {
    ...
    Edisi Buku Jujutsu Kaisen
        ...
        <?php if (count($jjk_books) === 0): ?>
            <p>Tidak ada buku Jujutsu Kaisen ditemukan.</p>
        <?php else: ?>

            <?php foreach ($jjk_books as $buku): ?>
                    ...
                    <div class="detail-container">
                        ...
                        <div class="cover-box">
                            ...
                            if (!empty($cover)) {
                                ...
                                echo '<img src="../../cover/jjk_cover.jpg">';
                            }
                            ?>
    ...
    Pinjam Buku
            ...
            <?php if ($totalPage > 1): ?>
                <div class="pagination">
                    ...
                    <!-- PREV -->
                    <?php if ($page > 1): ?>
                        <a href="dashboard.php?page=detail_buku_jjk<?= $page - 1 == 1 ? '' : '&hal=' . ($page - 1) ?>">
                    ...
                    <?php for ($i = 1; $i <= $totalPage; $i++): ?>
                        <a href="dashboard.php?page=detail_buku_jjk<?= $i == 1 ? '' : '&hal=' . $i ?>"
                            class="<?= ($i == $page) ? 'active' : '' ?>">
                            <?= $i ?>
                        </a>
                    <?php endfor; ?>
                    ...
                    <?php if ($page < $totalPage): ?>
                        <a href="dashboard.php?page=detail_buku_jjk&hal=<?= $page + 1 ?>">
