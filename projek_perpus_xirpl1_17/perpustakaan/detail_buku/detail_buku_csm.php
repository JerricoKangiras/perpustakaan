...
// QUERY DINAMIS
// ======================
$where = "WHERE LOWER(s.judul_buku) LIKE '%chainsaw man%'";
...
$start = ($page - 1) * $limit;
$csm_books = array_slice($csm_books, $start, $limit);
?>
...
<head>
    ...
    <title>Detail Buku Chainsaw Man</title>
...
.input-box button:hover {
    ...
    Edisi Chainsaw Man
        ...
        <?php if (count($csm_books) === 0): ?>
            <p>Tidak ada buku Chainsaw Man ditemukan.</p>
        <?php else: ?>

            <?php foreach ($csm_books as $buku): ?>
                    ...
                    <div class="detail-container">
                        ...
                        <div class="cover-box">
                            ...
                            if (!empty($cover)) {
                                ...
                                echo '<img src="../../cover/csm_cover.jpg">';
                            }
                            ?>
    ...
    Pinjam Buku
            ...
            <?php if ($totalPage > 1): ?>
                <div class="pagination">
                    ...
                    <!-- PREV -->
                    <?php if ($page > 1): ?>
                        <a href="dashboard.php?page=detail_buku_csm<?= $page - 1 == 1 ? '' : '&hal=' . ($page - 1) ?>">
                    ...
                    <?php for ($i = 1; $i <= $totalPage; $i++): ?>
                        <a href="dashboard.php?page=detail_buku_csm<?= $i == 1 ? '' : '&hal=' . $i ?>"
                            class="<?= ($i == $page) ? 'active' : '' ?>">
                            <?= $i ?>
                        </a>
                    <?php endfor; ?>
                    ...
                    <?php if ($page < $totalPage): ?>
                        <a href="dashboard.php?page=detail_buku_csm&hal=<?= $page + 1 ?>">
