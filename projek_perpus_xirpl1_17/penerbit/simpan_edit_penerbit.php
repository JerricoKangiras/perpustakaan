...
$query = "UPDATE tbl_penerbit SET nama_penerbit='$np', notlp_penerbit='$notlpp', nama_sales='$ns', notlp_sales='$notlps' 
...
<head>
    ...
    <title>Status Update Penerbit</title>
...
<body>
    <div class="result-box">
        <?php if ($result) { ?>
            ...
            <p>Penerbit <strong><?= htmlspecialchars($np) ?></strong> berhasil diperbarui.</p>
        ...
        <?php } else { ?>
            ...
            <a href="dashboard.php?page=edit_penerbit" class="btn btn-error">Kembali</a>
        <?php } ?>
    </div>
</body>
</html>