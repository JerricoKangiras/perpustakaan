...
<main class="dashboard-main">
    <div class="card">
    <h2>Tambah Buku</h2>
    <p>Masukkan informasi buku dengan detail lengkap</p>

    <form method="POST" action="dashboard.php?page=simpan_buku">
        ...
        <div class="form-group">
            ...
            <textarea name="sinopsis_buku"></textarea>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <select name="id_kategori" class="select-search" required>
                    ...
                    <?php
                    $queryKategori = "SELECT id_kategori, nama_kategori FROM tbl_kategori";
            ...
            <div class="form-group">
                ...
                <select name="id_penerbit" class="select-search" required>
                    ...
                    <?php
                    $queryPenerbit = "SELECT id_penerbit, nama_penerbit FROM tbl_penerbit";
                    $resultPenerbit = mysqli_query($koneksi, $queryPenerbit);
                    while ($rowPenerbit = mysqli_fetch_array($resultPenerbit)) {
